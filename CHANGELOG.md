...
- **README rewrite** - Reworded the root README to foreground the relational vision — sovereign memory, consent-aware architecture, and the invitation to participate — drawing from the voice that had evolved in the MCP handler's `README_TEXT`
