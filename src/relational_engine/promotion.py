...
from relational_engine.context_compiler import sigmoid_decay
...
def evaluate_promotion(
    entry: Entry, reason: str, config: Optional[Config] = None
) -> PromotionDecision:
    """
...
def promote_and_append(
    entry: Entry, reason: str, config: Optional[Config] = None, state_dir: Optional[str] = None
