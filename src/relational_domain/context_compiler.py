...
class ContextCompiler:
    ...
    def compile_context(
        ...
        Args:
            ...
            preferred_provider: Explicit provider preference for embeddings

        Returns:
            ContextEnvelope with ranked entries and provider metadata
        ...
        # Step 1: Query vector store (now returns provider info)
        results_tuple = self.vector_store.query(
        ...
        candidates, provider_used, fallback_occurred = results_tuple
